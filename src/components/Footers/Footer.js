...
export default function Footer() {
  return (
    <>
      <footer className="relative bg-lightBlue-50 mt-12 pt-2 pb-6">
        <div
        ...
        >
          ...
          >
            <polygon
              className="text-lightBlue-50 fill-current"
              ...
              <div class="flex items-center gap-4 mt-10">
                <div class="social-button">
                  <button class="relative w-12 h-12 rounded-full group">
                    <div
                      class="floater w-full h-full absolute top-0 left-0 bg-[#925E78] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
                    ></div>
                    <div
                      class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#925E78] rounded-full"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="22"
